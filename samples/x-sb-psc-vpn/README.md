...
This module provides a southbound private service connect (PSC) connectivity with a hybrid NEG
between an Apigee X runtime and a sample backend located on premises (here simulated as another VPC).
